...
Original file is located at
    https://colab.research.google.com/drive/1cMDNhyTHcbmtz_vUhNNWE_QgAsIHXckB
"""
...
def augmented_train(image, label):
    ...
    if random.random() > 0.5:
        image = tf.contrib.image.rotate(image, 45 * math.pi / 180, interpolation='BILINEAR')  # c-2
    image = tf.image.random_brightness(image, 0.2)  # c-3
    image = tf.image.random_contrast(image, 0.1, 1.9)  # c-3
